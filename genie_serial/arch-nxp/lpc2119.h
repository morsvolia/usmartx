...
#define GPIO2_IOPIN	(*(REG32 (0xE0028020))) /* only for LPC229x */
#define GPIO2_IOSET	(*(REG32 (0xE0028024))) /* only for LPC229x */
#define GPIO2_IODIR	(*(REG32 (0xE0028028))) /* only for LPC229x */
#define GPIO2_IOCLR	(*(REG32 (0xE002802C))) /* only for LPC229x */

#define GPIO3_IOPIN	(*(REG32 (0xE0028030))) /* only for LPC229x */
#define GPIO3_IOSET	(*(REG32 (0xE0028034))) /* only for LPC229x */
#define GPIO3_IODIR	(*(REG32 (0xE0028038))) /* only for LPC229x */
#define GPIO3_IOCLR	(*(REG32 (0xE002803C))) /* only for LPC229x */
